...
export const BASELINE_TASKS: Task[] = [
  ...
  // ─── COGNITIVE (~4 min) ─────────────────────────────────────────────
  {
    ...
    instruction:
      "Read the digits out loud once, then type them back into the box in the same order.",
    direction: "forward",
    digits: [7, 2, 9, 4, 6, 1, 8],
    durationSeconds: 60,
    modality: "none",
  },
  {
    ...
    instruction:
      "Read the digits out loud once, then type them back in reverse order.",
    direction: "backward",
    digits: [5, 3, 8, 2, 7],
    durationSeconds: 60,
    modality: "none",
